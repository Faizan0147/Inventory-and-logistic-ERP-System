...
async def get_invoice(conn: asyncpg.Connection, invoice_id: str) -> Optional[InvoiceRead]:
    row = await conn.fetchrow(
        """
...
async def update_invoice(
    conn: asyncpg.Connection, invoice_id: str, data: InvoiceUpdate, updated_by: Optional[str] = None
...
async def delete_invoice(
    conn: asyncpg.Connection, invoice_id: str, deleted_by: Optional[str] = None
) -> bool:
